package com.github.ahatem.qtranslate.presentation.viewmodels

import com.github.ahatem.qtranslate.common.Localizer
import com.github.ahatem.qtranslate.models.*
import com.github.ahatem.qtranslate.presentation.main_frame.QTranslateFrame
import com.github.ahatem.qtranslate.services.text_extractor.ApiNinjasTextExtractor
import com.github.ahatem.qtranslate.services.text_extractor.GoogleTextExtractor
import com.github.ahatem.qtranslate.services.text_extractor.OcrSpaceTextExtractor
import com.github.ahatem.qtranslate.services.translators.abstraction.TextToSpeechNotSupportedException
import com.github.ahatem.qtranslate.services.translators.abstraction.UnsupportedLanguageException
...
fun Language.Companion.getAutoDetectLanguage(detectedLanguage: Language? = null): Language {
    return Language(
        if (detectedLanguage != null && detectedLanguage.name != "auto") "Auto detect (%s)".format(
...
object QTranslateViewModel {
    ...
    private val _inputLanguage =
        MutableStateFlow(if (Configurations.currentInputLanguage != "auto") Language(Configurations.currentInputLanguage) else Language.getAutoDetectLanguage())
    ...
    suspend fun translate(text: String? = null) {
        ...
        runCatching {
            ...
            if (Configurations.showBackwardTranslationPanel) {
                val backwardTranslationResult =
                    translator.translate(translationResult.translatedText, inputLang, outputLang)
