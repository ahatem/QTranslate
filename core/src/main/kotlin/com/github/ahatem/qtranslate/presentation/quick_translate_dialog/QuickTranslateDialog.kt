package com.github.ahatem.qtranslate.presentation.quick_translate_dialog
...
import com.github.ahatem.qtranslate.presentation.listeners.common.ComponentMover
import com.github.ahatem.qtranslate.presentation.listeners.common.ComponentResizer
import com.github.ahatem.qtranslate.presentation.main_frame.panels.TranslatorsPanel
...
class QuickTranslateDialog(frame: JFrame) : JDialog(frame, ModalityType.MODELESS) {
    ...
    init {
        ...
        buttons.withIndex().forEach { (index, button) ->
            if (index == QTranslateViewModel.selectedTranslatorIndex.value && !button.isSelected) button.isSelected =
                true
        }
    ...
    private fun createTopPanel(): JPanel {
        val closeButton = createButtonWithIcon("app-icons/cross-circle.svg", 13).apply {
            ...
            addActionListener {
                ...
                this@QuickTranslateDialog.dispatchEvent(
                    WindowEvent(
                        this@QuickTranslateDialog,
    ...
    private fun getDialogTitle(): JLabel {
      ...
      <HTML>
        <BODY>
          ${
            Localizer.localize("quick_translate_panel_title").format(inputLangText, outputLangText)
        }${"&nbsp;".repeat(6)}
        </BODY>
      </HTML>
    """.trimIndent()
