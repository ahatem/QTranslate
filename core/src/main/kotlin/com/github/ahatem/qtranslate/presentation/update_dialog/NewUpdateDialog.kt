...
class NewUpdateDialog(frame: Frame, latestVersionInfo: LatestVersionInfo) :
    JDialog(frame, Localizer.localize("new_update_panel_title"), true) {
    ...
    init {
        ...
        val headerTitle =
            JLabel(Localizer.localize("new_update_panel_text_new_version_available")).apply {
                putClientProperty(
                    "FlatLaf.styleClass",
                    "h3"
                )
        ...
        val releaseNotesLabel = JLabel(Localizer.localize("new_update_panel_text_release_notes")).apply {
            putClientProperty(
                "FlatLaf.styleClass",
                "h4"
            )
        ...
        val remindLaterButton =
            JButton(Localizer.localize("new_update_panel_button_text_remind_later")).apply { addActionListener { dispose() } }
