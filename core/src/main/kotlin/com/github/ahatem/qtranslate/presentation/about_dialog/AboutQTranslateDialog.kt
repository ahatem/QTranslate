package com.github.ahatem.qtranslate.presentation.about_dialog
...
class AboutQTranslateDialog(frame: Frame) : JDialog(frame, Localizer.localize("about_panel_title"), true) {
    ...
    init {
        ...
        val closeButton =
            JButton(Localizer.localize("about_panel_button_text_close")).apply { addActionListener { dispose() } }
