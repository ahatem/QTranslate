...
class TranslationActionsPanel : JPanel() {
    ...
    val copyButton = createButtonWithIcon(
        "app-icons/copy-alt.svg",
        16,
        Localizer.localize("main_panel_button_tooltip_copy_translation")
    )
    val listenButton = createButtonWithIcon(
        "app-icons/headphones.svg",
        16,
        Localizer.localize("main_panel_button_tooltip_listen_translation")
    )
