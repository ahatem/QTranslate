...
class TranslationOptionsPanel : JPanel() {
    ...
    val clearButton = createButtonWithIcon(
        "app-icons/trash.svg",
        iconSize,
        Localizer.localize("main_panel_button_tooltip_clear_translation")
    ).apply {
    ...
    val swapButton = createButtonWithIcon(
        "app-icons/swap.svg",
        iconSize,
        Localizer.localize("main_panel_button_tooltip_change_translation_direction")
    ).apply {
