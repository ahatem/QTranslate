package com.github.ahatem.qtranslate.presentation.main_frame
...
import com.github.ahatem.qtranslate.presentation.components.JXTrayIcon
...
import com.github.ahatem.qtranslate.presentation.loading_dialog.LoadingDialog
import com.github.ahatem.qtranslate.presentation.main_frame.layouts.LayoutFactory
import com.github.ahatem.qtranslate.presentation.main_frame.layouts.MainPanel
import com.github.ahatem.qtranslate.presentation.main_frame.menus.OptionsPopupMenu
import com.github.ahatem.qtranslate.presentation.main_frame.menus.TrayPopupMenu
...
import com.github.ahatem.qtranslate.utils.setupTheme
...
class QTranslateFrame : JFrame("QTranslate") {
            ...
            launch {
                QTranslateViewModel.spells.collectLatest {
                    ...
                    for (word in it.corrections) {
                        mainPanel.translationInputPanel.inputTextArea.addUnderlineHighlight(
                            word.startIndex,
                            word.endIndex
                        )
    ...
    private fun createTrayMenu() {
        ...
        UIManager.addPropertyChangeListener {
            if ("lookAndFeel" == it.propertyName) trayIcon.jPopupMenu = TrayPopupMenu()
        }
    }
